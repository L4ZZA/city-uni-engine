...
example_layer::example_layer() 
	...
	,m_3d_camera(static_cast<float>(engine::application::window().width()),
				 static_cast<float>(engine::application::window().height()))
{
	...
	std::dynamic_pointer_cast<engine::gl_shader>(mesh_material_shader)->set_uniform("gMatSpecularIntensity", 1.f);
