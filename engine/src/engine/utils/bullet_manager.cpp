...
engine::bullet_manager::~bullet_manager()
{
    ...
    // TODO: do not use cast to uint but change the type of i to size_t
...
void engine::bullet_manager::init_physics(
    ...
    btDynamicsWorld* dynamics_world)
{
    ...
    // TODO, this will create a memory leak, as the init_pysics is called twice (see both constructors). Fix please.
